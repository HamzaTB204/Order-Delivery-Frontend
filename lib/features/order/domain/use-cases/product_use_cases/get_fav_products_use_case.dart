...
class GetFavProductsUseCase extends Equatable {
  final ProductRepository productRepository;

  const GetFavProductsUseCase({required this.productRepository});

  Future<Either<AppFailure, List<ProductEntity>>> call(String token) async {
    return await productRepository.getFavProducts(token);
  }
